...
const FAQ_ITEMS = [
    {
        ...
        answer: "We've done this for dozens of local businesses across tree surgery, surveyors, insurance agencies, and more. We only take on businesses we know we can rank - that's why we've never had to refund anyone (so far). Before we take your money, we audit your market and only proceed if we're confident we can get you there. If we can't deliver top 3 in 90 days, we'll work for free until we do."
    },
    {
        question: "2. What's this actually going to cost me total?",
        answer: "If and provided we can help you out, we will offer you two different payment plans. One is monthly and the other one is a prepayment for the quarter. For this specific package it's either £400 / month or £1000 / quarter."
    },
    {
        question: "3. Will this work for my specific type of business?",
        answer: "If you're a local business with a physical service area, yes. We've ranked tree surgeons, surveyors, insurance agencies, contractors - the system works for any local service business. On our call, we'll tell you straight up if your market is too competitive or if there's something that would prevent us from ranking you. We don't take your money if we can't deliver."
    },
    {
