                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                    ...
                    <div className="md:col-span-5 space-y-6">
                        ...
                        <p className="text-brand-gray/80 text-xl leading-relaxed max-w-sm font-medium">
                            ...
                            <span className="text-brand-green font-serif italic">Built for local businesses.</span>
                        </p>
                        <div className="flex items-center gap-4">
                            {/* Instagram */}
                            <Link href="#" className="w-10 h-10 rounded-full bg-brand-black/5 flex items-center justify-center hover:bg-brand-green/10 transition-colors group">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-black/60 group-hover:text-brand-green transition-colors">
                    ...
                    <div className="md:col-span-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 sm:gap-8">
                        {/* Company (was Explore) */}
                        <div>
                            <h4 className="font-bold text-xs uppercase tracking-widest text-brand-green mb-6">Company</h4>
                        ...
                        <div>
                            <h4 className="font-bold text-xs uppercase tracking-widest text-brand-green mb-6">Services</h4>
                        ...
                        {/* Legal */}
                        <div>
                            <h4 className="font-bold text-xs uppercase tracking-widest text-brand-green mb-6">Legal</h4>
                            <ul className="space-y-4 text-sm font-medium text-brand-black/70">
