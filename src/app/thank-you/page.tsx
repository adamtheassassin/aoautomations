        ...
        if (isDisqualified) {
            return (
                <div className="max-w-3xl mx-auto text-center">
                    <div className="inline-block px-4 py-1.5 bg-red-500/10 rounded-lg mb-6">
                        <span className="text-sm font-bold uppercase tracking-widest text-red-600">Exploring Status</span>
                    </div>
                    <h1 className="text-5xl md:text-7xl font-bold text-brand-black tracking-tight leading-[1.0] mb-8">
                        Details <span className="font-serif italic font-bold text-red-600">Gestoor</span>
                    </h1>
                    <p className="text-lg md:text-xl text-brand-gray leading-relaxed max-w-xl mx-auto mb-8">
                        Aangesien jy tans net <strong className="text-brand-black">exploring</strong> doen, het ons jou details gestoor maar ons gaan nie nou al 'n custom video analysis vir jou opneem nie.
                    </p>
                    ...
                    <div className="bg-white/60 border border-brand-black/5 rounded-3xl p-6 mb-8 max-w-xl mx-auto text-left space-y-4 shadow-sm">
                        <h3 className="font-bold text-brand-black text-lg mb-2">Wat dit beteken:</h3>
                        <p className="text-brand-gray leading-relaxed text-sm">
                            Om ons analysis en programme premium te hou, prioritiseer ons custom teardowns vir besighede wat gereed is om in die volgende paar weke te rank.
                        </p>
                        <p className="text-brand-gray leading-relaxed text-sm">
                            Moenie bekommerd wees nie – jou details is gestoor! As jy besluit om te begin rank, kontak ons gerus direk of vra vir 'n aktiewe analysis wanneer jy reg is.
                        </p>
                    </div>
                    ...
                    <div className="flex justify-center gap-4">
                        <Link
                            href="/"
                            className="bg-brand-black text-white hover:bg-brand-black/80 px-8 py-4 rounded-xl text-lg font-bold transition-all duration-300 hover:scale-[1.02] flex items-center justify-center"
                        >
                            Terug na Home Page
                        </Link>
                    </div>
            ...
            <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="flex justify-center">
                    ...
                    >
                        ...
                        <span className="relative z-10 drop-shadow-md">Stuur vir ons 'n boodskap op WhatsApp</span>
                    </a>
                </div>
            </div>
        );
