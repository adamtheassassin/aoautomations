...
export default function TradesBusinessesAfrikaansPage() {
    ...
    const handleContinueStep1 = () => {
        if (selectedAnswer === true) {
            ...
            // Default to true if not explicitly selected
            setStep("step2");
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                router.push("/thank-you?lang=af");
            } else {
                alert("Iets het verkeerd geloop. Probeer asseblief weer.");
            }
        } catch (error) {
            ...
            <section className="pt-24 pb-10 px-4 sm:px-6 md:pt-32 md:pb-16 flex-1 flex flex-col items-center justify-center">
                ...
                <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-8 px-2">
                    <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-brand-black tracking-tight leading-tight">
                        Ons help trade besighede om <br className="hidden sm:block" />
                        <span className="text-brand-green font-serif italic font-bold">meer local leads</span> van Google af te kry.
                    </h1>
                </div>
                            ...
                            <div className="space-y-4 sm:space-y-5 animate-fadeIn">
                                ...
                                <div>
                                    <h2 className="text-base sm:text-lg font-bold text-brand-black uppercase tracking-wide">
                                        BESIT JY 'N TRADE BESIGHEID?
                                    </h2>
                                    <p className="text-xs text-brand-gray font-medium mt-1">
                                        (bv. Plumbers, Electricians, Roofers, Aircon/HVAC, Landscapers, Builders, Painters, ens.)
                                    </p>
                                </div>
                        ...
                        {step === "disqualified" && (
                            <div className="text-center space-y-4 animate-fadeIn py-2">
                                ...
                                <h2 className="text-xl sm:text-2xl font-bold text-brand-black tracking-tight leading-tight">
                                    Ons werk net met <br />
                                    <span className="text-brand-green font-serif italic font-bold">trade besighede</span>
                                </h2>

                                <p className="text-xs sm:text-sm text-brand-gray leading-relaxed max-w-sm mx-auto">
                                    Ons growth stelsels en ranking frameworks is spesifiek gebou vir trades &amp; home service contractors. As gevolg hiervan kan ons ongelukkig nie op hierdie stadium kliënte buite die trades aanvaar nie.
                                </p>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-3.5">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            id="websiteOrSocial"
                                            required
                                            placeholder="https://facebook.com/joubesigheid"
                                            className="w-full bg-white border border-brand-black/15 rounded-xl px-4 py-2.5 sm:py-3 text-brand-black font-medium outline-none focus:border-brand-green focus:ring-4 focus:ring-brand-green/10 transition-all text-sm sm:text-base shadow-xs placeholder:text-brand-gray/40"
                                    ...
                                    <div className="flex items-center gap-3 pt-2">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            >
                                                {loading ? "Besig om te stuur..." : "Submit →"}
                                            </LiquidButton>
                                        </div>
                                    </div>
                                    ...
                                    <p className="text-center text-[11px] sm:text-xs text-brand-gray/80 pt-1 leading-relaxed font-medium">
                                        Ons sal jou local Google rankings ontleed en vir jou presies wys hoe om in die top 3 in jou area te rank.
                                    </p>
                                </form>
                            </div>
                        )}
